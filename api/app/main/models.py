...
class PurchaseOrder(models.Model):
    ...
    shippingCost = models.DecimalField(max_digits=10, decimal_places=2,default=0)
    ...
    lastBalance = models.DecimalField(max_digits=10, decimal_places=2,default=0)
...
class SalesOrder(models.Model):
    ...
    refno = models.CharField(max_length=256, unique=True)
    customer= models.ForeignKey(PeopleCustomer, on_delete=models.CASCADE, null=True, blank=True)
    progressStatus = models.CharField(max_length=64)
    paidStatus = models.CharField(max_length=64)
    desc = models.CharField(max_length=256, null=True, blank=True)
    author = models.CharField(max_length=64, null=True, blank=True)
