<template>
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="adduser.html" class="btn btn-added"><img src="/img/icons/plus.svg" alt="img" class="me-2">Add
                User</a>
        </div>
    </div>
                ...
                <table class="table  datanew">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="/img/customer/customer1.jpg" alt="product">
                                </a>
                            </td>
                            <td>Thomas</td>
                            <td>Thomas </td>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="/img/customer/customer2.jpg" alt="product">
                                </a>
                            </td>
                            <td>Benjamin</td>
                            <td>Franklin </td>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="/img/customer/customer3.jpg" alt="product">
                                </a>
                            </td>
                            <td>James</td>
                            <td>James </td>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="/img/customer/customer4.jpg" alt="product">
                                </a>
                            </td>
                            <td>Bruklin</td>
                            <td>Bruklin </td>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="/img/customer/customer5.jpg" alt="product">
                                </a>
                            </td>
                            <td>Franklin</td>
                            <td>Jacob </td>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="/img/customer/customer6.jpg" alt="product">
                                </a>
                            </td>
                            <td>B. Huber </td>
                            <td>Jacob </td>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="/img/customer/customer7.jpg" alt="product">
                                </a>
                            </td>
                            <td>Alwin</td>
                            <td>Alwin </td>
                        ...
                        <tr>
                            ...
                            <td class="productimgname">
                                <a href="javascript:void(0);" class="product-img">
                                    <img src="/img/customer/customer8.jpg" alt="product">
                                </a>
                            </td>
                            <td>Fred john</td>
                            <td>john </td>
