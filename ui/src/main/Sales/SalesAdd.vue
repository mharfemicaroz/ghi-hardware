        ...
        <div class="row">
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                <tr v-for="item of filteredSalesBook">
                  <td>
...
import { salesOrderApi, salesItemApi } from "@/services/salesServices";
...
export default {
  ...
  computed: {
    subtotal() {
      return this.filteredSalesBook.reduce(
