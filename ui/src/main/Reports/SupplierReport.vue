                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="return-tab" data-bs-toggle="tab" data-bs-target="#return" type="button"
                            role="tab" aria-controls="return" aria-selected="false">Return</button>
                    </li>
                </ul>
                            ...
                            <table class="table datanew">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a class="product-img">
                                                <img src="/img/product/product7.jpg" alt="product">
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a class="product-img">
                                                <img src="/img/product/product8.jpg" alt="product">
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a class="product-img">
                                                <img src="/img/product/product9.jpg" alt="product">
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a class="product-img">
                                                <img src="/img/product/product10.jpg" alt="product">
                                            </a>
