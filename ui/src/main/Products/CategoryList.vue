<template>
    <div class="page-header">
        <div class="page-title">
            <h4>Product Category list</h4>s
            <h6>View/Search product Category</h6>
        </div>
        <div class="page-btn">
            <router-link class="btn btn-added" @click="navigateTo('/index/addcategory')" to="/index/addcategory">
                ...
                <table class="table  datanew">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Admin</td>
                            <td>
                                <router-link class="me-3" @click="navigateTo('/index/editcategory')" to="/index/editcategory">
