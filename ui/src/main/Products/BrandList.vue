<template>
    <div class="page-header">
        ...
        <div class="page-btn">
            <router-link class="btn btn-added" @click="navigateTo('/index/addbrand')" to="/index/addbrand">
                ...
                <table class="table datanew">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a class="product-img">
                                    <img src="/img/brand/samsung.png" alt="product">
                                </a>
                            </td>
                            <td>samsung</td>
                            <td>Electronics</td>
                            <td>
                                <router-link class="me-3" @click="navigateTo('/index/editbrand')" to="/index/editbrand">
